...
conferenceApp.controllers.controller('MyProfileCtrl',
    function ($scope, $log, oauth2Provider, HTTP_ERRORS) {
        ...
        /**
         * Candidates for the Office Location select box.
         * @type {string[]}
         */
         $scope.cities = [
             'Chicago',
        ...
        $scope.init = function () {
            var retrieveProfileCallback = function () {
                ...
                /**
                  gapi.client.learnica.getProfile()
                    ...
                    execute(function (resp) {
                        $scope.$apply(function () {
                            ...
                            if (resp.error) {
                                ...
                                $scope.profile.jobPosition = resp.jobPosition;
                                $scope.profile.phone = resp.result.phone;
                                $scope.profile.email = resp.result.email;
                                $scope.profile.skype = resp.result.skype;
